...
@section('content')
    ...
    asset('storage/users/latar_belakang/'.$user->get_bio->latar_belakang) : asset('images/slider/beranda-pekerja.jpg')}}')">
        ...
        <div class="page-title">
            <h2>{{$layanan->judul}}</h2>
            <p>Kategori {{$layanan->get_sub->get_kategori->nama.': '.$layanan->get_sub->nama}}</p>
        </div>
        <ul class="crumb">
                                        ...
                                        <div class="row text-center">
                                            <div class="col-lg-12">
                                                <button id="btn_order" style="border: 1px solid #eee"
                                                    ...
                                                    {{$cek > 0 ? 'TELAH DIPESAN' : 'PESAN SEKARANG'}}
                                                </button>
                                            </div>
                                        </div>
                                        ...
                                        <table style="font-size: 14px;">
                                            ...
                                            <span style="color: #ffc100">
                                                ...
                                                @else
                                                    ...
                                                    <i class="far fa-star"></i>
                                                @endif </span>
                                                    <b>{{round($rating_pekerja * 2) /2}}</b> ({{count($ulasan_pekerja)}}
                                                    ulasan)
                                                </td>
                                            </tr>
                                            <tr>
                                ...
                                <ul id="myTab" class="nav nav-tabs nav-tabs-responsive" role="tablist">
                                    ...
                                    <li role="presentation" class="next">
                                        <a class="nav-item nav-link" href="#ulasan" id="ulasan-tab"
                                           ...
                                           aria-expanded="true"><i class="fa fa-comments mr-2"></i>ULASAN KLIEN
                                            <span class="badge badge-secondary">

...
@section('content')
    ...
    asset('storage/users/latar_belakang/'.$user->get_bio->latar_belakang) : asset('images/slider/beranda-proyek.jpg')}}')">
        ...
        <ul class="crumb">
            ...
            <li><i class="fa fa-angle-double-right"></i> <a href="{{route('dashboard.klien.proyek')}}">Daftar
                    Tugas/Proyek & Pengerjaan</a></li>
            <li><a href="#" onclick="goToAnchor()"><i class="fa fa-angle-double-right"></i> Daftar Bid</a></li>
        </ul>
    </div>
